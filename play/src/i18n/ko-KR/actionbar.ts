...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    botEditorModule: {
        ...
        visionHelper:
            "이미지를 볼 수 있는 공급자는 👁로 표시됩니다 — 플레이어가 보낸 이미지는 추가 설정 없이 자동으로 처리됩니다.",
        aiProviderLabel: "AI 공급자",
        aiProviderHelp: "(이 봇의 AI 공급자 선택)",
        loadingProviders: "공급자 로드 중...",
        retry: "다시 시도",
        noProvidersConfigured: "AI 공급자가 구성되지 않았습니다. 먼저 관리 API에서 공급자를 설정하세요.",
        errorNotInitialized: "봇 API 서비스가 초기화되지 않았습니다",
        errorNoProviders: "사용 가능한 AI 공급자가 없습니다. 관리 API에서 공급자를 구성하세요.",
        errorLoadFailed: "AI 공급자를 로드하지 못했습니다",
        providerVisionHeading: "AI 공급자 및 비전",
        chatInstructions: "채팅 지침",
        chatInstructionsHelp: "(봇이 무엇을 말하고 어떻게 소통해야 하는지)",
        chatInstructionsPlaceholder:
            "예: 당신은 'WelcomeBot'이라는 친근한 인사 봇입니다. 로비에 새로 온 방문자를 환영하는 것이 당신의 일입니다. 밝고 도움이 되세요. 공간에 대한 질문에 답하세요. 오늘 이미 인사한 사람에게 같은 인사를 반복하지 마세요.",
        noChatInstructions: "채팅 지침이 설정되지 않음",
    },
