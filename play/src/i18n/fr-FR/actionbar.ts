...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    botEditor: "Éditeur de bots",
    botEditorModule: {
        visionMarker: "👁 vision",
        providerDisabled: "(Désactivé)",
        visionHelper:
            "Les fournisseurs capables de voir les images sont marqués d'un 👁 — les images envoyées par les joueurs sont traitées automatiquement, sans configuration supplémentaire.",
        aiProviderLabel: "Fournisseur d'IA",
        aiProviderHelp: "(Sélectionnez le fournisseur d'IA pour ce bot)",
        loadingProviders: "Chargement des fournisseurs...",
        retry: "Réessayer",
        noProvidersConfigured:
            "Aucun fournisseur d'IA configuré. Configurez d'abord les fournisseurs dans l'API d'administration.",
        errorNotInitialized: "Service API du bot non initialisé",
        errorNoProviders: "Aucun fournisseur d'IA disponible. Configurez les fournisseurs dans l'API d'administration.",
        errorLoadFailed: "Échec du chargement des fournisseurs d'IA",
        providerVisionHeading: "Fournisseur d'IA et vision",
        chatInstructions: "Instructions de chat",
        chatInstructionsHelp: "(Ce que le bot doit dire et comment il doit communiquer)",
        chatInstructionsPlaceholder:
            "Exemple : vous êtes un bot d'accueil amical nommé 'WelcomeBot'. Votre travail consiste à accueillir les nouveaux visiteurs dans le hall. Soyez joyeux et serviable. Répondez aux questions sur l'espace. Ne répétez pas le même salut à quelqu'un que vous avez déjà salué aujourd'hui.",
        noChatInstructions: "Aucune instruction de chat définie",
    },
    ...
    help: {
        ...
        calendar: {
            title: "Calendrier",
            desc: "Consultez vos réunions à venir et rejoignez-les directement depuis Universe.",
        },
        todolist: {
