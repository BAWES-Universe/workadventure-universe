...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    here: {
        thisMap: "Cette carte",
        countHere: "{count} ici",
        onlyYou: "Vous êtes seul·e ici",
        hint: "Approchez-vous de quelqu'un pour discuter",
        seeWhoIsHere: "Voir qui est sur {mapName}",
    },
    nearby: {
        title: "Discussion de proximité",
        withNames: "Discussion de proximité · {names}",
