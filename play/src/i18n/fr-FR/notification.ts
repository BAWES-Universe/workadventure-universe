...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "Ne manquez aucune discussion. Activez les notifications pour être informé(e) lorsque quelqu'un souhaite vous parler, même si vous n'êtes pas sur l'onglet Universe.",
        firefoxContent:
