...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    guest: {
        title: "أنت هنا كضيف",
        intro: "دردشة القرب متاحة للجميع. بحساب يمكنك أيضًا:",
        messageAnyone: "مراسلة أي شخص في هذا العالم حتى لو كان بعيدًا عنك",
        keepChats: "الاحتفاظ بمحادثاتك بعد مغادرتك",
        groups: "إنشاء مجموعات والانضمام إلى التي تُدعى إليها",
