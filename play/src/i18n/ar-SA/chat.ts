...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    guest: {
        ...
        intro: "أنت تستكشف كضيف. دردشة القرب والأشخاص وExpress تعمل الآن. سجّل الدخول لكي:",
        messageAnyone: "تراسل أي شخص، وتنشئ مجموعات، وتحتفظ بكل محادثة",
        keepWoka: "تحتفظ بشخصيتك واسمك على كل أجهزتك",
        orbit: "تستكشف الكون كله مع Orbit وتنتقل إلى حيث يوجد الناس",
        build: "تبني غرفًا وبوتات في العوالم التي تجعلك عضوًا فيها",
    ...
    here: {
        ...
        hint: "اقترب من أحدهم لبدء دردشة القرب",
        seeWhoIsHere: "شاهد من في {mapName}",
    },
    nearby: {
        title: "دردشة القرب",
        withNames: "دردشة القرب · {names}",
