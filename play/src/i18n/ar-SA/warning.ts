...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "المتصفح الخاص بك ({browserName}) لم يعد مدعوماً من Universe.",
        description: "متصفحك قديم جداً لتشغيل Universe. يرجى تحديثه إلى أحدث إصدار للمتابعة.",
        whatToDo: "ماذا يمكنك أن تفعل؟",
        option1: "تحديث {browserName} إلى أحدث إصدار",
        option2: "مغادرة Universe واستخدام متصفح مختلف",
