...
const error: DeepPartial<Translation["error"]> = {
    ...
    connectionRetry: {
        unableConnect: "تعذر الاتصال بـ Universe. يرجى التأكد من أنك متصل بالإنترنت.", // Unable to connect to Universe. Please ensure you are connected to the internet.
    },
    errorDialog: {
        title: "خطأ 😱", // Error 😱
