...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "لا تفوت أي مناقشة. قم بتمكين الإشعارات لتكون على علم عندما يريد شخص ما التحدث معك، حتى لو لم تكن في علامة تبويب Universe.", // don't miss any discussion. Enable notifications to be informed when someone wants to talk to you, even if you are not in the Universe tab.
