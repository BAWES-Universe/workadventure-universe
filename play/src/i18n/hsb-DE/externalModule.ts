...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    discord: {
        ...
        explainText:
            "Hdyž zwjazujeće waše Discord-konto tu, budźeće móhli swoje powěsće direktnje w Universe-ćatje dóstać. Po synchronizowanju serwera załožimy runiny, kotrež wobsahuje, dyrbiće jenož k nim w Universe-ćatje přiwstupać.",
        ...
        guildExplain: "Wubjerće kanale, kotrež chceće k Universe-ćat-interfejsej přidać.\n",
    },
    outlook: {
        signIn: "Z Outlook so přizjewić",
        popupScopeToSync: "Moje Outlook-konto zwjazać",
        popupScopeToSyncExplainText:
            "Dyrbimy so z wašim Outlook-kontom zwjazać, zo by waš kalender a/abo nadawki synchronizował. To wam zmóžnja, waše zećělenja a nadawki w Universe widźeć a direktnje z kartow k nim wobdźělić.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Dyrbimy so z wašim Google-kontom zwjazać, zo by waš kalender a/abo nadawki synchronizował. To wam zmóžnja, waše zećělenja a nadawki w Universe widźeć a direktnje z kartow k nim wobdźělić.",
        popupScopeToSyncCalendar: "Mój kalender synchronizować",
        popupScopeToSyncTask: "Moje nadawki synchronizować",
        popupCancel: "Přetorhnyć",
