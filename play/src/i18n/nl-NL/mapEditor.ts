...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "Open Link",
            description: "Open website binnen Universe of in een nieuw tabblad.",
            linkLabel: "Link URL",
        ...
        googleDrive: {
            ...
            description: "Open Google Drive binnen Universe of in een nieuw tabblad.",
