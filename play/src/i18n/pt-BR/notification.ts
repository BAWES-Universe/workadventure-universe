...
const notification: BaseTranslation = {
    ...
    help: {
        ...
        content:
            "Não perca nenhuma discussão. Habilite as notificações para ser notificado quando alguém quiser falar com você, mesmo quando você não estiver na aba do Universe.",
        firefoxContent:
