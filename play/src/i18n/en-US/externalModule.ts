...
const externalModule: BaseTranslation = {
    ...
    discord: {
        ...
        explainText:
            "By connecting your discord account here, you will be able to receive your messages directly in the Universe chat. After synchronizing a server, we will create the rooms it contains, you will only have to join them in the Universe chat.",
        ...
        guildExplain: "Select channels you want to add to Universe chat interface.\n",
    },
    outlook: {
        signIn: "Sign in with Outlook",
        popupScopeToSync: "Connect my Outlook Account",
        popupScopeToSyncExplainText:
            "We need to connect to your Outlook account to synchronize your calendar and/or tasks. This will allow you to view your meetings and tasks in Universe and join them directly from the map.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "We need to connect to your Google account to synchronize your calendar and/or tasks. This will allow you to view your meetings and tasks in Universe and join them directly from the map.",
        popupScopeToSyncCalendar: "Synchronize my calendar",
        popupScopeToSyncTask: "Synchronize my tasks",
        popupCancel: "Cancel",
