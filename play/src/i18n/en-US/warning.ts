...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by Universe.",
        description: "Your browser is too old to run Universe. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave Universe and use a different browser",
