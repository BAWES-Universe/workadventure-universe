...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "リンクを開く",
            description: "Universe 内または新しいタブとしてウェブサイトを開きます。",
            linkLabel: "リンク URL",
        ...
        youtube: {
            ...
            description: "Universe 内で YouTube ビデオを開くか、新しいタブとして開きます。",
        ...
        googleDocs: {
            ...
            description: "Universe 内で Google ドキュメントを開くか、新しいタブとして開きます。",
        ...
        klaxoon: {
            label: "Klaxoon を開く",
            description: "Universe 内で Klaxoon を開くか、新しいタブとして開きます。",
        ...
        googleSheets: {
            label: "Google シートを開く",
            description: "Universe 内で Google シートを開くか、新しいタブとして開きます。",
        ...
        googleSlides: {
            ...
            description: "Universe 内で Google スライドを開くか、新しいタブとして開きます。",
        ...
        googleDrive: {
            ...
            description: "Universe 内で Google ドライブを開くか、新しいタブとして開きます。",
        ...
        openFile: {
            label: "ファイルを開く",
            description: "Universe 内でファイルを開く。",
