...
export class SocialBehavior extends BaseBehavior {
    ...
    protected override shouldDeliverGoodbye(spaceName: string, playerId: number): boolean {
        return this.currentSpaceName === spaceName && this.activeConversations.has(playerId);
    }
