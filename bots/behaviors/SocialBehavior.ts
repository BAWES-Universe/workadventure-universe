...
export class SocialBehavior extends BaseBehavior {
    ...
    protected override canSendGreetingToPlayer(spaceName: string, playerId: number): boolean {
        return Boolean(this.bot && this.currentSpaceName === spaceName && this.activeConversations.has(playerId));
    }
