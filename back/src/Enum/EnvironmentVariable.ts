...
export const UNIVERSE_WEB_VERSION = env.UNIVERSE_WEB_VERSION;
export const UNIVERSE_MIN_NATIVE_VERSION = env.UNIVERSE_MIN_NATIVE_VERSION;
export const UNIVERSE_LATEST_NATIVE_VERSION = env.UNIVERSE_LATEST_NATIVE_VERSION;
export const UNIVERSE_ANDROID_UPDATE_URL = env.UNIVERSE_ANDROID_UPDATE_URL;
export const UNIVERSE_IOS_UPDATE_URL = env.UNIVERSE_IOS_UPDATE_URL;
